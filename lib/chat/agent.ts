  ...
  return [
    {
      ...
      content: [
        ...
        "If Current Ora context includes Focus intent, Widget type, or Selected data summary, answer that specific object or widget. Use the selected data summary as the starting facts, and do not give generic page or store-chat questions.",
        ...
        "For focused widget or card answers, followup_chips must stay specific to that selected widget, card, Signal step, or ActionPlan.",
